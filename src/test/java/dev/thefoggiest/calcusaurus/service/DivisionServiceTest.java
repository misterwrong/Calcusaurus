...
import dev.thefoggiest.calcusaurus.service.DivisionService;
...
{
    /**
     * Test of createAssignment method, of class DivisionService.
     */
    @Test
    public void testCreateAssignment()
    {
        int min = 1;
        int max = 3;
        DivisionService instance = new DivisionService();
        SimpleAssignment result = instance.createAssignment(min, max);
        assertTrue(result.getFirstNumber() >= min);
        assertTrue(result.getSecondNumber() >= min);
