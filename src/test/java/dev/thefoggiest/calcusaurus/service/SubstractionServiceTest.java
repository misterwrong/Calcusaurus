...
import dev.thefoggiest.calcusaurus.service.SubstractionService;
...
{
    /**
     * Test of createAssignment method, of class SubstractionService.
     */
    ...
    public void testCreatePositiveAssignment()
    {
        ...
        for (int i = 0; i < 10; ++i)
        {
            var assignment = service.createAssignment(min, max);

            assertTrue(assignment.getFirstNumber() >= min && assignment.getSecondNumber() <= max);
